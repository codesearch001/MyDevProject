...
import com.snofed.publicapp.utils.Constants.BROWSE_CLUB_DETAILS
import com.snofed.publicapp.utils.Constants.BROWSE_CLUB_LIST
import com.snofed.publicapp.utils.Constants.CLUB_EVENT
import com.snofed.publicapp.utils.Constants.CLUB_EVENT_DETAILS
import com.snofed.publicapp.utils.Constants.CLUB_TRAILS_CHART
import com.snofed.publicapp.utils.Constants.CLUB_TRAILS_DETAILS
import com.snofed.publicapp.utils.Constants.CLUB_TRAILS_DRAW_POLYLINES
import com.snofed.publicapp.utils.Constants.GET_ALL_FEEDS
import com.snofed.publicapp.utils.Constants.GET_ALL_FEEDS_DETAILS
import com.snofed.publicapp.utils.Constants.LOGIN
import com.snofed.publicapp.utils.Constants.RECOVER_PASSWORD
import com.snofed.publicapp.utils.Constants.REGISTER
...
interface UserAPI {
    ...
    suspend fun trailsDetails(@Header("Accept-Language") acceptLanguage: String,@Path("id") id: String) : Response<TrailsDetilsResponse>

    //CLUB_TRAILS_DRAW_POLYLINES
    @GET(CLUB_TRAILS_DRAW_POLYLINES)
    suspend fun trailsDrawPolyLinesByID(@Header("Accept-Language") acceptLanguage: String,@Path("id") id: String) : Response<TrailPolyLinesResponse>

    //CLUB_TRAILS_CHART
    @GET(CLUB_TRAILS_CHART)
    suspend fun trailsGraphDetails(@Header("Accept-Language") acceptLanguage: String,@Path("id") id: String) : Response<TrailGraphData>
}